...
/**
 * Possible cammadns that can be sent via socket.
 * @author Derilas
 */
public class Commands {

	static public const SET_TARGET_TAB : String = "setTargetTab";
	static public const RENAME_TAB : String = "renameTab";
	static public const ENABLE_TABS : String = "enableTabs";
	static public const DISABLE_TABS : String = "disableTabs";
